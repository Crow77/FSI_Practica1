...
def tree_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print "Numeros de nods expandidos", nodeCount
            return node
...
def graph_search(problem, fringe):
    ...
    while fringe:
        node = fringe.pop()
        if problem.goal_test(node.state):
            print "Numeros de nodos expandidos ", nodeCount
            return node
...
def RMporCoste(problem):
    return graph_search(problem, orderListByCost())         # orderListByCost -> fringe

def RMporCosteHeuristica(problem):
    """Search the cheapest movement from current node to the next node."""
    return tree_search(problem, orderListByCostAndHeuristic(problem))  # orderListByCostAndHeuristic -> fringe
